...
# Facing North
  # Diamond
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:2b,Item:{id:"minecraft:diamond_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/north/structure_alt run function extruder:gen_check
  # Netherite
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:2b,Item:{id:"minecraft:netherite_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/north/structure_alt run function extruder:gen_check
# Facing South
  # Diamond
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:3b,Item:{id:"minecraft:diamond_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/south/structure_alt run function extruder:gen_check
  # Netherite
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:3b,Item:{id:"minecraft:netherite_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/south/structure_alt run function extruder:gen_check
# Facing West
  # Diamond
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:4b,Item:{id:"minecraft:diamond_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/west/structure_alt run function extruder:gen_check
  # Netherite
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:4b,Item:{id:"minecraft:netherite_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/west/structure_alt run function extruder:gen_check
# Facing East
  # Diamond
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:5b,Item:{id:"minecraft:diamond_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/east/structure_alt run function extruder:gen_check
  # Netherite
    # Alt 1
    ...
    # Alt 2
      execute as @e[type=minecraft:glow_item_frame,nbt={Facing:5b,Item:{id:"minecraft:netherite_pickaxe"}},nbt={Item:{tag:{Enchantments:[{lvl:1s,id:"minecraft:efficiency"}]}}}] at @s if predicate industrial_machines:extruder/east/structure_alt run function extruder:gen_check
